;;; x-ivy-occur-then-wgrep.el --- Command to open wgrep buffer from ivy result.  -*- lexical-binding: t; -*-
...
(provide 'x-ivy-occur-then-wgrep)

;;; x-ivy-occur-then-wgrep.el ends here
