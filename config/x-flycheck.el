;;; x-flycheck.el --- Flycheck configuration. -*- lexical-binding: t; -*-
...
(use-package flycheck
  ...
  (progn
    ...
    (defun x-flycheck-display-error-messages (errors)
    ...
    (defun x-flycheck-toggle-error-list ()
  ...
  (progn
    ...
    (setq flycheck-display-errors-function 'x-flycheck-display-error-messages)
    ...
    (spacemacs-keys-set-leader-keys
      ...
      "el" 'x-flycheck-toggle-error-list
