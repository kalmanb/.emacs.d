;;; x-ibuffer.el --- Configuration for ibuffer  -*- lexical-binding: t; -*-
...
(use-package ibuffer
  ...
  (defun x-ibuffer--hacky-show-line-only ()
  ...
  (progn
    ...
    (setq ibuffer-never-show-predicates
          (list (rx (or "*Messages*"
                        ...
                        "*Help*"))))
    (add-hook 'ibuffer-hook #'x-ibuffer--hacky-show-line-only t)
...
(use-package ibuffer-projectile
  ...
  :init
  (add-hook 'ibuffer-hook #'x-ibuffer--setup-buffer))

(provide 'x-ibuffer)

;;; x-ibuffer.el ends here
