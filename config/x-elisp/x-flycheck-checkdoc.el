;;; x-flycheck-checkdoc.el --- Configure checkdoc checker.  -*- lexical-binding: t; -*-
...
(defconst x-flycheck-checkdoc-form
...
(provide 'x-flycheck-checkdoc)

;;; x-flycheck-checkdoc.el ends here
