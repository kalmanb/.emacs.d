;;; x-flycheck-stylelint.el --- Integrate stylelint with flycheck
...
(defun x-web--project-or-root-stylelintrc ()
...
(flycheck-def-config-file-var flycheck-stylelintrc
    (css-stylelint) (x-web--project-or-root-stylelintrc)
  :safe #'stringp)
...
(provide 'x-flycheck-stylelint)

;;; x-flycheck-stylelint.el ends here
