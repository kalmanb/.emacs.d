;;; x-ivy.el --- Configuration for Ivy.  -*- lexical-binding: t; -*-
...
(use-package ivy
  ...
  :preface
  (progn
    (autoload 'x-ivy-occur-then-wgrep "x-ivy-occur-then-wgrep")
    ...
    (defun x-ivy-with-empty-ivy-extra-directories (f &rest args)
  ...
  (progn
    ...
    (advice-add #'counsel-find-file :around #'x-ivy-with-empty-ivy-extra-directories)

    (define-key ivy-minibuffer-map (kbd "<f1>") #'x-ivy-help)
    ...
    (define-key ivy-minibuffer-map (kbd "C-c C-e") #'x-ivy-occur-then-wgrep)
